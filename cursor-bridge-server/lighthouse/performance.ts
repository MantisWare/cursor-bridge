...
/**
 * Performance-specific report content structure (speed demon mode activated! ⚡🚀)
 */
...
/**
 * Performance audit adapted for AI consumption (speed demon mode! ⚡🏃‍♂️)
...
export async function runPerformanceAudit(
  ...
  try {
    ...
    throw new Error(
      `Performance audit got tired: ${
        error instanceof Error ? error.message : String(error)
      } - even speed demons need a coffee break! ⚡☕`
    );
  }
}
