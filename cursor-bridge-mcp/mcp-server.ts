...
server.tool(
  "getConsoleErrors",
  "Catch those sneaky console errors that are causing trouble! 🐛✨",
  async () => {
    return await withServerConnection(async () => {
      const response = await fetch(
...
server.tool(
  "takeScreenshot",
  "Snap a perfect screenshot of your browser tab - capture the moment! 📸✨",
  async () => {
    return await withServerConnection(async () => {
      try {
        const response = await fetch(
...
server.tool(
  "getSelectedElement",
  "Inspect the element that caught your eye - what's the user really clicking on? 👀🎯",
  async () => {
    return await withServerConnection(async () => {
      const response = await fetch(
...
server.tool(
  ...
  "Make your site accessible to everyone! Run a comprehensive accessibility audit that actually cares! ♿❤️",
  {},
  async () => {
    return await withServerConnection(async () => {
      try {
...
server.tool(
  "runPerformanceAudit",
  "Turn your site into a speed demon! Run a performance audit that hunts down those sneaky bottlenecks! ⚡🏃‍♂️",
  {},
  async () => {
    return await withServerConnection(async () => {
      try {
...
server.tool(
  "runSEOAudit",
  "Make Google fall in love with your site! Run an SEO audit that turns you into a search engine whisperer! 🔍💕",
  {},
  async () => {
    return await withServerConnection(async () => {
      try {
...
server.tool(
  "runDebuggerMode",
  "Enter detective mode! Debug your app like a pro with our comprehensive debugging toolkit! 🕵️‍♀️🔍",
  async () => ({
    content: [
      {
        type: "text",
...
server.tool(
  "runAuditMode",
  "Enter audit mode! Run the full suite of audits to make your app absolutely amazing! 🎯✨",
  async () => ({
    content: [
      {
        type: "text",
...
server.tool(
  ...
  "Check if you're following web development best practices - with love, not judgment! ✅💕",
  {},
  async () => {
    return await withServerConnection(async () => {
      try {
